...
const (
	...
	EventTaskLeaseRenewed        = "task.lease_renewed"
	EventTaskLeaseBroken         = "task.lease_broken"
	EventTaskLeaseConflict       = "task.lease_conflict"
	EventTaskLeaseLegacy         = "task.lease_legacy"
